...
impl Connection {
    ...
    ///
    /// See [`proto::Connection::peer_params_initial_max_streams_bidi`].
    pub fn peer_params_initial_max_streams_bidi(&self) -> u64 {
        self.0
            .state
            .lock("peer_params_initial_max_streams_bidi")
            .inner
            .peer_params_initial_max_streams_bidi()
    }
    ...
    pub fn peer_params_initial_max_streams_uni(&self) -> u64 {
        self.0
            .state
            .lock("peer_params_initial_max_streams_uni")
            .inner
            .peer_params_initial_max_streams_uni()
    }
    ...
    pub fn peer_params_initial_max_data(&self) -> u64 {
        self.0
            .state
            .lock("peer_params_initial_max_data")
            .inner
