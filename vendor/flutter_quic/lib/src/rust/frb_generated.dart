...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1178098848;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiBridgeConfigureQuicSessionStorage({
    required String path,
    required List<int> key,
  });

  Future<(QuicSendStream?, QuicRecvStream?)> crateApiBridgeConnectionAcceptBi({
    required QuicConnection connection,
  });
  ...
  Future<String?> crateApiBridgeConnectionCloseReason({
    required QuicConnection connection,
  });

  Future<BigInt> crateApiBridgeConnectionDatagramSendBufferSpace({
    required QuicConnection connection,
  });

  Future<String?> crateApiBridgeConnectionLocalIp({
    required QuicConnection connection,
  });

  Future<BigInt?> crateApiBridgeConnectionMaxDatagramSize({
    required QuicConnection connection,
  });

  Future<(QuicSendStream, QuicRecvStream)> crateApiBridgeConnectionOpenBi({
    required QuicConnection connection,
  });

  Future<QuicSendStream> crateApiBridgeConnectionOpenUni({
    required QuicConnection connection,
  });

  Future<QuicPeerTransportParams> crateApiBridgeConnectionPeerTransportParams({
    required QuicConnection connection,
  });
  ...
  Future<SocketAddress> crateApiBridgeConnectionRemoteAddress({
    required QuicConnection connection,
  });

  Future<BigInt> crateApiBridgeConnectionRttMillis({
    required QuicConnection connection,
  });

  Future<void> crateApiBridgeConnectionSendDatagram({
    required QuicConnection connection,
  ...
  Future<QuicConnectionStats> crateApiBridgeConnectionStats({
    required QuicConnection connection,
  });

  Future<bool> crateApiBridgeConnectionWaitHandshake({
    required QuicConnection connection,
  });
  ...
  Future<(QuicEndpoint, QuicConnection, bool)>
  crateApiBridgeEndpointConnectEarly({
    required String addr,
    required String serverName,
    String? qlogPath,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiBridgeConfigureQuicSessionStorage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeConfigureQuicSessionStorageConstMeta,
        argValues: [path, key],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBridgeConfigureQuicSessionStorageConstMeta =>
      const TaskConstMeta(
        debugName: "configure_quic_session_storage",
        argNames: ["path", "key"],
      );
  ...
  Future<(QuicSendStream?, QuicRecvStream?)> crateApiBridgeConnectionAcceptBi({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeConnectionAcceptBiConstMeta,
        argValues: [connection],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBridgeConnectionAcceptBiConstMeta =>
      const TaskConstMeta(
        debugName: "connection_accept_bi",
        argNames: ["connection"],
      );
  ...
  Future<QuicPeerTransportParams> crateApiBridgeConnectionPeerTransportParams({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_quic_peer_transport_params,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiBridgeConnectionPeerTransportParamsConstMeta,
        argValues: [connection],
        apiImpl: this,
      ),
    );
  ...
  Future<SocketAddress> crateApiBridgeConnectionRemoteAddress({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_socket_address,
          decodeErrorData: null,
        ),
  ...
  Future<QuicConnectionStats> crateApiBridgeConnectionStats({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_quic_connection_stats,
          decodeErrorData: null,
        ),
  ...
  Future<bool> crateApiBridgeConnectionWaitHandshake({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeConnectionWaitHandshakeConstMeta,
        argValues: [connection],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiBridgeConnectionWaitHandshakeConstMeta =>
      const TaskConstMeta(
        debugName: "connection_wait_handshake",
        argNames: ["connection"],
      );
  ...
  crateApiBridgeEndpointConnectEarly({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiBridgeEndpointConnectEarlyConstMeta,
        argValues: [addr, serverName, qlogPath],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiBridgeEndpointConnectEarlyConstMeta =>
      const TaskConstMeta(
        debugName: "endpoint_connect_early",
        argNames: ["addr", "serverName", "qlogPath"],
      );
  ...
  dco_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicRecvStream(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicRecvStream(
      raw,
    );
  }
  ...
  dco_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicSendStream(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicSendStream(
      raw,
    );
  }
  ...
  sse_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicRecvStream(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicRecvStream(
      deserializer,
    ));
  }
  ...
  sse_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicSendStream(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicSendStream(
      deserializer,
    ));
  }
  ...
  sse_decode_opt_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicRecvStream(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerQuicRecvStream(
        deserializer,
      ));
    } else {
      return null;
