...
Agent should pick a single item from this list and proceed with it. If it can be handled, do so, mark the item done with a tick, and commit (but do not push) the result.
